...
drr_data<- read.csv("Input/data/24022020_DRR_KAP_Clean_data.csv", 
                    stringsAsFactors = FALSE,header = T,na.strings = c(""," ", "n/a",NA)) 
...
actions_before_cyclone_rc_withot_dntknw_go <- c("X_18_What_actions_would_you_ta.don_t_know","X_18_What_actions_would_you_ta.go_to_a_cyclone_shelter")


one_flag_meaning_right<- c("X_39_What_does_it_mean_when_on.a_storm_is_near__it_may_not_re","X_39_What_does_it_mean_when_on.if_the_storm_moves_away_or_wea")
